...
This project now uses [GitHub Actions](https://github.com/architdate/PokeFilename/actions) to auto build the plugin every commit. People who are not keen on building the project themselves may download the built plugin from the workflow run.
